...
from Pix2Pix.pix2pixHD import LocalEnhancer, MultiscaleDiscriminator, Loss
...
def run(cfg):
    ...
    gen = LocalEnhancer(in_channels=3, out_channels=1).to(cfg.device).apply(weights_init)
